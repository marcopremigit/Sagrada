...
public class MediumShadesTest {
    ...
    public void fromJSONtoPublic(){
        ...
        jsonObject.put("name", "Sfumature Medie");
        jsonObject.put("objective", "Test");
        jsonObject.put("points", 2);
        card= (MediumShades) PublicObjective.fromJSONtoPublic(jsonObject);
        Assert.assertEquals("Sfumature Medie",card.getName());
    ...
    public void fromPublicToJSON(){
        ...
        Assert.assertEquals("Sfumature Medie", jsonObject.getString("name"));
        Assert.assertEquals("Set di 3 & 4 ovunque", jsonObject.getString("objective"));
