...
public class DarkShadesTest {
    ...
    public void fromJSONtoPublic(){
        ...
        jsonObject.put("name", "Sfumature Scure");
        jsonObject.put("objective", "Test");
        jsonObject.put("points", 2);
        card= (DarkShades) PublicObjective.fromJSONtoPublic(jsonObject);
        Assert.assertEquals("Sfumature Scure",card.getName());
    ...
    public void fromPublicToJSON(){
        ...
        Assert.assertEquals("Sfumature Scure", jsonObject.getString("name"));
        Assert.assertEquals("Set di 5 & 6 ovunque", jsonObject.getString("objective"));
