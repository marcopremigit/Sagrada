...
public class PennelloPerEglomiseTest {
    ...
    public void changeDicePosition() {
        ...
        //first test
        try {
            PennelloPerEglomise.changeDicePosition(scheme,0,0,2,3);
        }
        ...
        //second test
        try {
            schemeCell[2][3]=new SchemeCell(Color.BLUE);
            PennelloPerEglomise.changeDicePosition(scheme,2,2,2,3);
        }
        catch (WrongInputException e){}
        catch (CannotPlaceDiceException e){}
        ...
        //third test
        try {
            Assert.assertEquals(true, PennelloPerEglomise.changeDicePosition(scheme,2,1,2,3).equals(scheme));
